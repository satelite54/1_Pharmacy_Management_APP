...
public class CatalogController implements Initializable {
	...
	private void showBookDetails(Medicine medicine) { //<== newValue 는 books 의 객체
		if(medicine != null) {
			//널 값이 아닐때
			label1.setText( Integer.toString(medicine.getPrice()));
		}
		else {
    ...
    public void deleteRow() {
    	String sql = "DELETE Medicine where price= ?"; // ID 만 조회를 함.
    	...
    	try {
    		...
    		pstmt.setInt(1, Integer.parseInt(label1.getText())); // ID == 숫자
